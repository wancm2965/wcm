...
KBASE_API void AssemblyGroupID(const std::string& strDomain,unsigned long ulGroupID,unsigned long& ulNewGroupID);

/* 将ulNewGroupID拆分成nLevel和ulGroupID*/
KBASE_API void UnAssemblyGroupID(unsigned long ulNewGroupID,unsigned int& nLevel,unsigned long& ulGroupID);

/* 将ulNewGroupID拆分出ulGroupID*/
KBASE_API unsigned long UnAssemblyGroupID2UL(unsigned long ulNewGroupID);

/* 将strNewGroupID拆分出strGroupID*/
KBASE_API std::string UnAssemblyGroupID2STR(const std::string& strNewGroupID);
