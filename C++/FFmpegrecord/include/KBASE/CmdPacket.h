...
// 命令包类定义
//=======================================================================================
class KBASE_API KCmdPacket
{
public:
	KCmdPacket(const std::string& xns,int cmd,const std::string& userid);
...
//=======================================================================================
class KBASE_API KCmdUserDataPacket : public KCmdPacket
{
public:
	KCmdUserDataPacket()
		:KCmdPacket("",0){};
...
//=======================================================================================
class KBASE_API KCmdPacketEx : public KCmdPacket
{
public:
	//-----------------------------------------------------
	KCmdPacketEx(const std::string& xns,int cmd,const std::string& userid)
