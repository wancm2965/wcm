================================================================================
    MICROSOFT 基础类库: bmp2H264 项目概述
===============================================================================

应用程序向导已为您创建此 bmp2H264 应用程序。此应用程序不仅演示使用 Microsoft 基础类的基本知识，而且可作为编写应用程序的起点。

此文件包含组成 bmp2H264 应用程序的各个文件的内容摘要。
...
bmp2H264.h
    这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 Cbmp2H264App 应用程序类。

bmp2H264.cpp
    这是包含应用程序类 Cbmp2H264App 的主要应用程序源文件。

bmp2H264.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\bmp2H264.ico
    这是用作应用程序图标的图标文件。此图标包括在主要资源文件 bmp2H264.rc 中。
...
bmp2H264Dlg.h，bmp2H264Dlg.cpp - 对话框
    这些文件包含 Cbmp2H264Dlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 bmp2H264.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 bmp2H264.pch 的预编译头(PCH)文件和名为 StdAfx.obj 的预编译类型文件。
