...
{
public:
	ClientConnection(WinVNCClient&rWinVNCClient);
	ClientConnection(WinVNCClient&rWinVNCClient,SOCKET sock);
	...
	int SetFullScreen(int nFullScreen);
	int SendCtrlEsc(void);
	int SendCtrlAltDel(void);
	int SetUse8Bit(int nUse8Bit);
private:
