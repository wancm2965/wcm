...
//---------------------------------------------------------------------------------------
void AssemblyGroupID(const std::string& strDomain,unsigned long ulGroupID,unsigned long& ulNewGroupID)
{
	//unsigned int nLevel = GetDomainLevel(strDomain);
	//unsigned long ulChangeCode = nLevel << 28;
	//ulNewGroupID = ulChangeCode | ulGroupID;
}

//---------------------------------------------------------------------------------------
void UnAssemblyGroupID(unsigned long ulNewGroupID,unsigned int& nLevel,unsigned long& ulGroupID)
{
	nLevel = ulNewGroupID >> 28;
	ulGroupID = 268435455 & ulNewGroupID;
}

//---------------------------------------------------------------------------------------
unsigned long UnAssemblyGroupID2UL(unsigned long ulNewGroupID)
{
	unsigned long ulGroupID = 268435455 & ulNewGroupID;
	return ulGroupID;
}

//---------------------------------------------------------------------------------------
std::string UnAssemblyGroupID2STR(const std::string& strNewGroupID)
{
	unsigned long ulNewGroupID = STR2ULONG(strNewGroupID);
	unsigned long ulGroupID = 268435455 & ulNewGroupID;
	return ULONG2STR(ulGroupID);
}
