...
AFX_EXT_CLASS std::string GetLowestCommonParentDomain(const std::string& strDomain1,const std::string& strDomain2);
AFX_EXT_CLASS std::string GetUserResource(const std::string& strUserID);
