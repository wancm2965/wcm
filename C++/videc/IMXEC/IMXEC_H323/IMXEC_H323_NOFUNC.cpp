...
{
	return 0; ////H323CallMgr::Instance().SetH323ID(cszH323ID);
}
...
{
	return 0; ////H323CallMgr::Instance().SetTelNumber(cszTelNumber);
}
...
{
	return 0; ////H323CallMgr::Instance().SetRegPassword(cszRegPassword);
}
...
{
	return 0; ////H323CallMgr::Instance().SetUserName(cszUserName);
}
...
{
	return 0; ////H323CallMgr::Instance().SetRegHost(cszHost);
}
...
{
	return 0; ////H323CallMgr::Instance().Register(nType);
}
...
{
	return 0; ////H323CallMgr::Instance().UnRegister();
}
...
{
	return 0; ////H323CallMgr::Instance().GetRegState(nRegState);
}
...
{
	return 0; ////H323CallMgr::Instance().SetH323ListenPort(nH323ListenPort);
}
...
{
	return 0; ////H323CallMgr::Instance().SetLocalIP(cszLocalIP);
}
...
int IMXEC_H323::SetRTPBasePort(unsigned short nRTPBasePort)
{
	...
	return 0; ////H323CallMgr::Instance().SetRTPBasePort(nRTPBasePort);
}
...
{
	return 0; ////H323CallMgr::Instance().SetAudioDevParam(nAudioCodecID);
}
...
{
	return 0; ////H323CallMgr::Instance().SetMainVideoDevParam(nDevID,nFrameRate,nBitrate,nVideoCodecType,nVideoFormatType,nNetworkType);
}
...
{
	return 0; ////H323CallMgr::Instance().SetSecondVideoDevParam(nDevID,nFrameRate,nBitrate,nVideoCodecType,nVideoFormatType,nNetworkType);
}
...
{
	return 0; ////H323CallMgr::Instance().Start();
}
...
{
	return 0; ////H323CallMgr::Instance().SetSupportH239(nSupportH239);
}
...
{
	return 0; ////H323CallMgr::Instance().DAPSendCallH245ControlMessage(cszCallID,nMsgType, cszPacket,nPacketLen);
}

int IMXEC_H323::SetCallRTPMediaMulticast(const char*cszCallID,const char*cszMulticastIP,int ttl)
{
	return 0; ////H323CallMgr::Instance().SetCallRTPMediaMulticast(cszCallID,cszMulticastIP,ttl);
}
