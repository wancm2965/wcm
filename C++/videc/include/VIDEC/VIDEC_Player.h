...
public:
	...
	//成功返回0，失败返回-1
	virtual int Open(HWND hWndParent, unsigned long*lpnVideoTimestamp = NULL, unsigned long*lpnAudioTimestamp = NULL, char* pBgBmp = NULL, int bgcolr = -1, int bgcolg = -1, int bgcolb = -1) = 0;
	//关闭显示窗口
	...
	virtual int GetVideoDecodeFrameRate(void)=0;
	...
	virtual void SetCacheFrameCount(int nCacheFrameCount)=0;
