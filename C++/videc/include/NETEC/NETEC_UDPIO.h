...
public:
	...
	virtual int32_t GetSocketHandleCount(void)=0;
	virtual SOCKET GetSocketHandleByIndex(int32_t nIndex)=0;
	virtual const char*GetLocalIPByHandle(SOCKET hSocket)=0;
	virtual int32_t GetSocketHandleIPV4(SOCKET*pahSocket,int32_t nCount)=0;
	virtual int32_t GetSocketHandleIPV6(SOCKET*pahSocket,int32_t nCount)=0;
};
