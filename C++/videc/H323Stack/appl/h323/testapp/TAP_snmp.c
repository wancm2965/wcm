...
RvBool snmpInitialized = RV_FALSE;
 ...
 * input   : none
 * output  : none
 * return  : RV_TRUE if SNMP package can be used
 ********************************************************************************************/
RvBool SNMP_IsInitialized(void)
{
#ifdef USE_SNMP
