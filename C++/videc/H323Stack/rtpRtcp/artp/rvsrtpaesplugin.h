...
//#define  RvRtpEncryptionAESPlugInInitialize(thisPtr, purpose, direc, key, keybit, blockbitsize, iv ) 					  (thisPtr)->initCBCMode((thisPtr),(purpose), (direc), (key), (keybit), (blockbitsize), (iv) )
