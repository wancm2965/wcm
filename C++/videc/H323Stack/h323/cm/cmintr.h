...
typedef struct __cmElem
{
    ...
    RvPvtNodeId sysConf;  /* the node of the system configuration tree */
    ...
    HPST            synH235Key;
    HPST            synConfCommon; /*syntax tree of tempSystemParams node in the system configuration*/
    ...
    RvBool              altEpModifySetup; /* altEp automatically modify setup message */
    HPST                synConfRAS;
    ...
    /*NAT support*/
    RvPvtNodeId natrasAddresses; /* NAT translation of SEQUENCE OF TransportAddress holding all listening RAS addresses*/
    RvPvtNodeId natq931TpktAddresses; /* NAT translation of SEQUENCE OF TransportAddress holding all listening TPKT addresses */
    RvPvtNodeId natq931AnnexEAddresses; /* NAT translation of SEQUENCE OF TransportAddress holding all listening Annex E addresses */

    RvBool      gatekeeperInNat;    /*indicates the GK location in relation to this Endpoint
                                      (in or out the LAN behind the same NAT machine)*/
    /*DNS*/
    RVHDNS dnsManager;            /*DNS module of the stack*/
