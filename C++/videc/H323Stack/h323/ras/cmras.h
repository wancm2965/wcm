...
typedef enum
{
    ...
    cmRASReasonRequestDenied,                   /* ARJ - no bandwidth available */
    ...
    cmRASReasonSecurityDHmismatch,              /* ARJ, LRJ - mismatch of DH parameters */
    cmRASReasonNoRouteToDestination,            /* ARJ, LRJ - destination unreachable */
    cmRASReasonUnallocatedNumber                /* ARJ, LRJ - destination number unassigned */
...
typedef enum
{
    ...
    cmRASParamRestart,                      /* RvBool - RRQ restart indication  */
    cmRASParamSourceEndpointInfo,           /* cmAlias                          */
    cmRASParamModifiedSrcInfo,              /* cmAlias                          */
    cmRASParamCanMapSrcAlias,               /* RvBool                           */
    cmRASParamAltEpCallSignalAddress,       /* alternate Ep's Call Signal Address */
    cmRASParamAltEpAliasAddress,
    cmRASParamLast
} cmRASParam;
