...
typedef struct
{
   ...
   /* Channel Information */
    ...
    cmExtendedFastConnectState_e eRemExtendedFastConnectState;
	RvBool                  bFSWaitForReply;       /* Indication that the EP waits for reply for FS proposal */
    RvUint8                 fastStartNodesNewPrplSendIndex; /* indication as to the beginning of a new, simultanious, FS proposal */
