...
#define cmiGetExtendedFastConnectStatus(hsCall,bOrigin) (cmExtendedFastConnectNo)
#define cmiSetExtendedFastConnectStatus(hsCall,newEFCState) (RV_ERROR_NOTSUPPORTED)
#define cmiSetRemoteExtendedFastConnectStatus(hsCall,remEFCState) (RV_ERROR_NOTSUPPORTED)
