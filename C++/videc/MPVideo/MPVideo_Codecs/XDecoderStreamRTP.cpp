...
{
	XDecoderStreamRTP*pXDecoderStream=new XDecoderStreamRTP(rCallback);
...
XDecoderStreamRTP::XDecoderStreamRTP(MPVideo_DecoderStreamCallback&rCallback)
...
void XDecoderStreamRTP::OnMPVideo_DecoderCallbackFrame(MPVideo_Decoder*pDecoderFrame,MPVideo_Image*pImage)
{
	...
	m_rCallback.OnMPVideo_DecoderStreamCallbackFrame(pXImage);
}

void XDecoderStreamRTP::OnMPVideo_DecoderCallbackFramePacket(MPVideo_Decoder*pDecoderFrame,void*pPacketData,int nPacketLen,int nWidth,int nHeight)
{
	m_rCallback.OnMPVideo_DecoderStreamCallbackFramePacket(pPacketData,nPacketLen,nWidth,nHeight);
}
