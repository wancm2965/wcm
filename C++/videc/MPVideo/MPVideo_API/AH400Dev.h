...
public:
	...
	void OnMPVIDEO_AH400CallbackImage(MPVIDEO_Image*pImage);
	void OnMPVIDEO_AH400CallbackVideoStreamData(unsigned char*pData,int nLen,int nWidth,int nHeight,int nHeaderLen);
	void OnMPVIDEO_AH400CallbackVideoSubStreamData(unsigned char*pData,int nLen,int nWidth,int nHeight,int nHeaderLen);
	void OnMPVIDEO_AH400CallbackAudioStreamData(unsigned char*pData,int nLen);
	void OnMPVIDEO_AH400CallbackMotionDetected(int*pResultList,int nResultCount);
