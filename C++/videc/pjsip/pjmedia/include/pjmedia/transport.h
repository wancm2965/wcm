...
PJ_DECL(pj_status_t) pj_get_ice_enum_cands(pjmedia_transport *tp,
											  unsigned comp_id,
											  unsigned *count,
											  pj_ice_sess_cand cand[]);

typedef enum pj_ice_cand_type pj_ice_cand_type;

PJ_DECL(pj_status_t) pj_add_ice_valid_check(pjmedia_transport *tp,
										   pj_uint8_t comp_id,
...
PJ_DECL(pj_status_t) pj_parse_cand(pjmedia_transport *tp,
								  pj_pool_t *pool,
