...
typedef void __stdcall fptr_on_sound_dev_pcm_data(short*pMic,short*pSpk,int nSamples,int nSampleRate);

PJ_DECL(pj_status_t) pjmedia_echo_set_sound_dev_pcm_data(fptr_on_sound_dev_pcm_data* fptr_on_sound_dev_data);
