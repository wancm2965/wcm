...
//sip msg change
typedef pj_ssize_t __stdcall SIPMSG_Change_CallBackT(char * msg,pj_ssize_t msgLen,pjsip_msg * sipStruct);
extern SIPMSG_Change_CallBackT * SIPMSG_Change_CallBack;
PJ_DECL(void) SetSIPMSGChangeHandle(SIPMSG_Change_CallBackT SIPMSGChange);
//}}gaoshizhong 20130428 Add
...
PJ_DECL(int) pjsip_get_status_code(pj_str_t * pjStatus);
//}}gaoshizhong 20141106 Add
