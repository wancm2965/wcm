...
int xvid_colorspace_init(int cpu_flags)
{
	...
	if ((cpu_flags & FF_CPU_MMX) || (cpu_flags & FF_CPU_MMXEXT) ||
		(cpu_flags & FF_CPU_3DNOW) || (cpu_flags & FF_CPU_3DNOWEXT) ||
		(cpu_flags & FF_CPU_SSE) || (cpu_flags & FF_CPU_SSE2))
	{
