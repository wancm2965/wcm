...
static void _decode_button(BITBUFFER *bb, BD_IG_BUTTON *p)
{
    ...
    p->nav_cmds     = (bd_mobj_cmd_s *)calloc(p->num_nav_cmds, sizeof(bd_mobj_cmd_s));
...
static void _decode_bog(BITBUFFER *bb, BD_IG_BOG *p)
{
    ...
    p->button      = (BD_IG_BUTTON *)calloc(p->num_buttons, sizeof(BD_IG_BUTTON));
...
static void _decode_effect(BITBUFFER *bb, BD_IG_EFFECT *p)
{
    ...
    p->composition_object      = (BD_PG_COMPOSITION_OBJECT *)calloc(p->num_composition_objects, sizeof(BD_PG_COMPOSITION_OBJECT));
...
static void _decode_effect_sequence(BITBUFFER *bb, BD_IG_EFFECT_SEQUENCE *p)
{
    ...
    p->window      = (BD_PG_WINDOW *)calloc(p->num_windows, sizeof(BD_PG_WINDOW));
    ...
    p->effect      = (BD_IG_EFFECT *)calloc(p->num_effects, sizeof(BD_IG_EFFECT));
...
static void _decode_page(BITBUFFER *bb, BD_IG_PAGE *p)
{
    ...
    p->bog      = (BD_IG_BOG *)calloc(p->num_bogs, sizeof(BD_IG_BOG));
...
static int _decode_interactive_composition(BITBUFFER *bb, BD_IG_INTERACTIVE_COMPOSITION *p)
{
    ...
    p->page      = (BD_IG_PAGE *)calloc(p->num_pages, sizeof(BD_IG_PAGE));
