...
{
    BD_DIR_H *dir = (BD_DIR_H *)malloc(sizeof(BD_DIR_H));
    ...
    MultiByteToWideChar(CP_UTF8, MB_ERR_INVALID_CHARS, filespec, -1, wfilespec, sizeof(wfilespec) / sizeof(*wfilespec));

    dir_data_t *priv     = (dir_data_t *)calloc(1, sizeof(dir_data_t));
