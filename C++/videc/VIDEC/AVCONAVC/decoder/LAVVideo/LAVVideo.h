...
class CLAVVideo : public CTransformFilter, public ILAVVideoSettings, public ILAVVideoStatus, public ILAVVideoCallback, public VideoDecoder, protected CAMThread
{
public:
