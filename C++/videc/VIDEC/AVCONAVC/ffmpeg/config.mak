...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-ldflags='-L../thirdparty/lib32 -L./zlib' --extra-cflags='-I./zlib -I../thirdparty/include -I../common/includes/dxva2 -mmmx -msse -mfpmath=sse' --disable-shared --enable-gpl --enable-version3 --enable-w32threads --enable-runtime-cpudetect --enable-demuxers --disable-demuxer=matroska --disable-filters --enable-filter=yadif --enable-filter=buffer --enable-filter=buffersink --enable-filter=scale --disable-protocols --enable-protocol=file --enable-protocol=mmsh --enable-protocol=mmst --enable-protocol=rtp --enable-protocol=http --disable-muxers --enable-muxer=spdif --disable-hwaccels --enable-hwaccel=h264_dxva2 --enable-hwaccel=vc1_dxva2 --enable-hwaccel=wmv3_dxva2 --enable-hwaccel=mpeg2_dxva2 --enable-libspeex --enable-libopencore-amrnb --enable-libopencore-amrwb --disable-avdevice --disable-avresample --disable-postproc --disable-swresample --enable-static --disable-debug --disable-encoders --disable-bsfs --disable-devices --disable-ffplay --disable-ffserver --disable-ffmpeg --disable-ffprobe --arch=x86 --cpu=i686 --target-os=mingw32 --build-suffix=-lav
prefix=/usr/local
...
CFLAGS= -I./zlib -I../thirdparty/include -I../common/includes/dxva2 -mmmx -msse -mfpmath=sse -march=i686 -std=c99 -fno-common -fomit-frame-pointer -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -I./zlib -I../thirdparty/include -I../common/includes/dxva2 -mmmx -msse -mfpmath=sse -march=i686
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -L../thirdparty/lib32 -L./zlib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lws2_32 -lspeex -lopencore-amrwb -lopencore-amrnb -lm -lz -lpsapi 
INSTALL=install
LIBTARGET=i386
...
VCODEC_TESTS=amv cljr dnxhd_720p_10bit ffvhuff flashsv2 jpeg2000 mpng msvideo1 prores prores_kostya qtrle qtrlegray r210 v210 v308 v408 vref y41p yuv4 zlib zmbv 
