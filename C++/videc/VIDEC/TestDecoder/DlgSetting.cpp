...
DlgSetting::DlgSetting(DlgMain&rDlgMain)
	...
	, m_bEncode(FALSE)
	, m_bDecode(FALSE)
	, m_nDecoderCount(m_rDlgMain.m_nDecoderCount)
{
}
...
void DlgSetting::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EDIT_DECODER_COUNT, m_editDecoderCount);
	DDX_Text(pDX, IDC_EDIT_DECODER_COUNT, m_nDecoderCount);
}
...
void DlgSetting::OnBnClickedOk()
{
	...
	m_rDlgMain.m_nDecoderCount=m_nDecoderCount;
