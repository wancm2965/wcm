...
// XIS_SetAudioCaptureFormat has been abolished. Don't call it.
BOOL
LIBXISTREAM_API
...
typedef void (*LPFN_D9_RENDERER_CALLBACK)(void * pvParam);

BOOL
LIBXISTREAM_API
XIS_SetD9RendererCallback(
	HANDLE						hD9Renderer,
	LPFN_D9_RENDERER_CALLBACK	lpfnD9RendererCallback,
	void *						pvParam
	);

HANDLE
LIBXISTREAM_API
XIS_GetD9RendererInstance(
	HANDLE	hD9Renderer
	);

void
LIBXISTREAM_API
XIS_DestroyD9Renderer(
	HANDLE	hD9Renderer
	);
