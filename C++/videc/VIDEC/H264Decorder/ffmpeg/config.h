...
#define FFMPEG_CONFIGURATION "--enable-static --enable-memalign-hack --enable-gpl --enable-libx264 --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib"
