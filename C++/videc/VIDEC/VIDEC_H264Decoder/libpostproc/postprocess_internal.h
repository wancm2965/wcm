...
/* FFDShow modification (used by Cpostproc.c to allow both chroma and luma postprocessing)
...
typedef struct PPContext{
    ...
    stride_t qpStride; ///<size of qp buffers (needed to realloc them if needed)
...
static inline void linecpy(void *dest, const void *src, int lines, stride_t stride) {
    if (stride > 0) {
