 ...
 *      
 *  transcode is FREEMSG software; you can redistribute it and/or modify
...
#define read(f,p,n)			fread(p,1,n,(FILE*)f)
#define write(f,p,n)		fwrite(p,1,n,(FILE*)f)
#define lseek(f,pos,flag)	fseek((FILE*)f,pos,flag)
...
int  AVI_write_frame(avi_t *AVI, char *data, long bytes, int keyframe,long frame_index);
