...
const int16_t vector_dimension1[NUM_CATEGORIES] =
{
    2,  2,  2,  4,  4,  5,  5,  1
};

const int16_t number_of_vectors1[NUM_CATEGORIES] =
{
    10, 10, 10, 5,  5,  4,  4, 20
};
/* The last category isn't really coded with scalar quantization. */

const int16_t max_bin1[NUM_CATEGORIES] =
{
    13, 9, 6, 4, 3, 2, 1, 1
};

const int16_t max_bin_plus_one_inverse1[NUM_CATEGORIES] =
{
...
#else
const float region_standard_deviation_table1[REGION_POWER_TABLE_SIZE] =
{
...
#else
const float standard_deviation_inverse_table1[REGION_POWER_TABLE_SIZE] =
{
...
#else
/* The last category isn't really coded with scalar quantization. */
const float step_size1[NUM_CATEGORIES] =
{
    0.3536f,
    0.5f,
    0.7071f,
...
const float step_size_inverse_table1[NUM_CATEGORIES] =
{
    2.82805443e+00f,
    2.00000000e+00f,
    1.41422713e+00f,
...
#else
const float dead_zone1[NUM_CATEGORIES] =
{
    0.3f,
    0.33f,
    0.36f,
...
#if !defined(G722_1_USE_FIXED_POINT)
const float region_power_table1[REGION_POWER_TABLE_SIZE] =
{
    5.96046448e-08f,
    1.19209290e-07f,
    2.38418579e-07f,
...
const float region_power_table_boundary1[REGION_POWER_TABLE_SIZE - 1] =
{
    8.42936956e-08f,
    1.68587391e-07f,
    3.37174782e-07f,
