...
int16_t g7221_samples_to_rmlt_coefs(const int16_t new_samples[],
                              int16_t history[],
                              int16_t coefs[],
                              int dct_length);

void g7221_rmlt_coefs_to_samples(int16_t *coefs,
                           int16_t *old_samples,
                           int16_t *out_samples,
                           int dct_length,
                           int16_t mag_shift);
...
void categorize1(int number_of_regions,
...
void g7221_samples_to_rmlt_coefs(const float new_samples[],
                           float old_samples[],
                           float coefs[],
                           int dct_length);

void g7221_rmlt_coefs_to_samples(float coefs[],
                           float old_samples[],
                           float out_samples[],
                           int dct_length);

void g7221_dct_type_iv(float input[], float output[], int dct_length);
