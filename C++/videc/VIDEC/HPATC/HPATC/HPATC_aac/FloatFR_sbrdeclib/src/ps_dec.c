            ...
            unsigned int noSubSamples)
{
  ...
  PTR_INIT(7);
  ptr1 = &sbr_OverlapBuffer[MAXNRSBRCHANNELS-1][0];
  ptr2 = &OverlapBuffer[OverlapBufferSize];
  ptr3 = &sbr_CodecQmfStatesAnalysis[QMF_FILTER_STATE_ANA_SIZE];
  ptr4 = &sbr_GainSmooth[MAXNRSBRCHANNELS-1][0];
  ptr5 = &sbr_NoiseSmooth[MAXNRSBRCHANNELS-1][0];
  ptr6 = &sbr_LpcFilterStatesReal[MAXNRSBRCHANNELS-1][0][0];
  ptr7 = &sbr_LpcFilterStatesImag[MAXNRSBRCHANNELS-1][0][0];
