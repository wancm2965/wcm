...
; *
; * $Id: cpuid.asm,v 1.1.1.1.2.2 2005/06/03 05:48:10 lixq Exp $
; ******************************************************************************/
...
cglobal check_cpu_features_h261
check_cpu_features_h261:
...
cglobal sse2_os_trigger_h261
align 16
sse2_os_trigger_h261:
	xorpd xmm0, xmm0
	ret
