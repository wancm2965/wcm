...
; *
; * $Id: quantize_mmx.asm,v 1.1.1.1.2.2 2005/06/03 05:48:10 lixq Exp $
; *
; *************************************************************************/
...
;===========================================================================
;
; void quant_intra_h261_mmx(int16_t * coeff, 
...
align ALIGN
cglobal quant_intra_h261_mmx
quant_intra_h261_mmx
...
;===========================================================================
;
; uint32_t quant_inter_h261_mmx(int16_t * coeff,
;					const int16_t const * data,
;					const uint32_t quant);
;
;===========================================================================
...
align ALIGN
cglobal quant_inter_h261_mmx
		quant_inter_h261_mmx
...
;===========================================================================
;
; void dequant_intra_h261_mmx(int16_t *data,
...
align ALIGN
cglobal dequant_intra_h261_mmx
dequant_intra_h261_mmx:
...
;===========================================================================
;
; void dequant_intra_h261_xmm(int16_t *data,
;					const int16_t const *coeff,
;					const uint32_t quant,
;					const uint32_t dcscalar);
;
;===========================================================================
  ...
  ; this is the same as dequant_inter_h261_mmx, except that we're
  ; saturating using 'pminsw' (saves 2 cycles/loop => ~5% faster)

align ALIGN
cglobal dequant_intra_h261_xmm
dequant_intra_h261_xmm:
...
;===========================================================================
;
; void dequant_inter_h261_mmx(int16_t * data,
;					const int16_t * const coeff,
;					const uint32_t quant);
;
;===========================================================================
...
align ALIGN
cglobal dequant_inter_h261_mmx
dequant_inter_h261_mmx:
...
;===========================================================================
;
; void dequant_inter_h261_xmm(int16_t * data,
;					const int16_t * const coeff,
;					const uint32_t quant);
;
;===========================================================================

  ; this is the same as dequant_inter_h261_mmx,
  ; except that we're saturating using 'pminsw' (saves 2 cycles/loop)

align ALIGN
cglobal dequant_inter_h261_xmm
dequant_inter_h261_xmm:
