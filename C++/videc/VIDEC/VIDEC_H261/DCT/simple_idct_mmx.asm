...
cglobal simple_idct_h261_mmx_P
cglobal simple_idct_h261_mmx

;-----------------------------------------------------------------------------
; void simple_idct_h261_mmx_P(int16_t * const block)
; expects input data to be permutated
;-----------------------------------------------------------------------------

ALIGN 16
simple_idct_h261_mmx_P:
  sub esp, 128
  mov edx, [esp+128+4]
...
;-----------------------------------------------------------------------------
; void simple_idct_h261_mmx(int16_t * const block)
;
; simple_idct_h261_mmx is the same function as simple_idct_h261_mmx_P above except that
