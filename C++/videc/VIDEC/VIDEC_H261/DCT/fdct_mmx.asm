...
; *
; * $Id: fdct_mmx.asm,v 1.1.1.1.2.2 2005/06/03 05:48:10 lixq Exp $
; *
; *************************************************************************/
...
cglobal fdct_h261_mmx
;;void fdct_h261_mmx(short *block);
fdct_h261_mmx:
...
cglobal fdct_h261_sse2
;;void f dct_h261_sse2(short *block);
fdct_h261_sse2:
