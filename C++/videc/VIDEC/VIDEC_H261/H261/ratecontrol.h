 ...
 *
 * $Id: ratecontrol.h,v 1.1.1.1.2.2 2005/06/03 01:32:02 lixq Exp $
 *
 ****************************************************************************/
...
void XvidRateControlInit(RateControl * rate_control,
...
int XvidRateControlGetQ(RateControl * rate_control,
					int keyframe);

void XvidRateControlUpdate(RateControl * rate_control,
					   int16_t quant,
					   int frame_size,
					   int keyframe);
#ifdef __cplusplus
