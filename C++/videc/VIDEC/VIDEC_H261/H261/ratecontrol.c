 ...
 *
 * $Id: ratecontrol.c,v 1.1.1.1.2.1 2005/06/03 00:57:46 lixq Exp $
 *
 ****************************************************************************/
...
void
XvidRateControlInit(RateControl * rate_control,
...
int
XvidRateControlGetQ(RateControl * rate_control,
				int keyframe)
{
...
void
XvidRateControlUpdate(RateControl * rate_control,
				  int16_t quant,
				  int frame_size,
				  int keyframe)
{
