...
; *
; * $Id: sad_sse2.asm,v 1.1.1.1.2.2 2005/06/03 05:48:10 lixq Exp $
; *
; ****************************************************************************/
...
cglobal  sad16_h261_mmxsse2
cglobal  dev16_h261_mmxsse2
...
;===========================================================================
;
; uint32_t sad16_h261_mmxsse2 (const uint8_t * const cur,
...
%if sad_debug=1
                jmp     sad16_h261_mmxsse2_ul
%endif
%if sad_debug=2
                jmp     sad16_h261_mmxsse2_semial
%endif        
%if sad_debug=3
                jmp     sad16_h261_mmxsse2_al
%endif

%if test_stride_alignment<>0
                test    ebx,15
                jnz     sad16_h261_mmxsse2_ul
%endif
                ...
                test    esi,15                     
                jnz     near sad16_h261_mmxsse2_semial           
                jmp     sad16_h261_mmxsse2_al

esi_unaligned:  test    edi,15
                jnz     near sad16_h261_mmxsse2_ul
                jmp     sad16_h261_mmxsse2_semial
...
;===========================================================================
;
; uint32_t dev16_h261_mmxsse2(const uint8_t * const cur,
;					const uint32_t stride);
;
; experimental!
;
...
%if dev_debug=1
                jmp     dev16_h261_mmxsse2_ul
%endif

%if dev_debug=2
                jmp     dev16_h261_mmxsse2_al
%endif

                test    esi,15
                jnz     near dev16_h261_mmxsse2_ul

%if test_stride_alignment=1
                test    ebx,15
                jnz     dev16_h261_mmxsse2_ul
%endif
