...
bool SDRDrawPin::DisplayFrame(unsigned char*pData,int nLen)
{
	...
	if (pSample==NULL)
	{
		DebugOutput( logcoreexcep ,"DisplayFrame GetDeliveryBuffer return \n");
		return false;
	}
	...
	if (pMediaType!=NULL)
	{
		...
		{
			pSample->Release();
			DebugOutput( logcoreexcep ,"DisplayFrame ChangeColorspace return \n");
			return false;
		}
	}
	...
	{
		pSample->Release();
		DebugOutput( logcoreexcep ,"DisplayFrame GetPointer return \n");
		return false;
	}
	...
	{
		pSample->Release();
		DebugOutput( logcoreexcep ,"DisplayFrame YV12_TO_RGB24 return \n");
		return false;
	}
