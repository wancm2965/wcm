...
public:
    explicit
    VideoDecoder(unsigned long nWidth,unsigned long nHeight,unsigned long nDispWidth,unsigned long nDispHeight, 
				 CUcontext &rContext,cudaVideoCreateFlags eCreateFlags, CUvideoctxlock &ctx);
