...
policies...
	...
	public:
		...
		T *allocate(const size_t n) const {
			...
			void *ptr = MALLOCMSG(size);
			if(!ptr)
			{
				//DebugOutput(logcoreerror,"new ipc alloc error \n");
		...
		void deallocate(T *p, const size_t n) const {
			...
			FREEMSG(p);
			//IPCPrintf(1,0,"IPCFree :%p,size:%d \n",p,n);
		}
...
#define NEDMALLOC_NEWIMPLPARSDEFS  P1 &p1
...
#define NEDMALLOC_NEWIMPLPARSDEFS  P1 &p1,  P2 &p2
...
#define NEDMALLOC_NEWIMPLPARSDEFS   P1 &p1,   P2 &p2,   P3 &p3
...
#define NEDMALLOC_NEWIMPLPARSDEFS   P1 &p1,   P2 &p2,   P3 &p3,   P4 &p4
...
#define NEDMALLOC_NEWIMPLPARSDEFS   P1 &p1,   P2 &p2,   P3 &p3,   P4 &p4,   P5 &p5
...
#define NEDMALLOC_NEWIMPLTYPES typename P1, typename P2, typename P3, typename P4, typename P5,typename P6 
#define NEDMALLOC_NEWIMPLPARSDEFS   P1 &p1,   P2 &p2,   P3 &p3,   P4 &p4,   P5 &p5 ,P6 &p6 
#define NEDMALLOC_NEWIMPLPARS p1, p2, p3, p4, p5,p6 
NEDMALLOC_NEWIMPL
#undef NEDMALLOC_NEWIMPLTYPES
#undef NEDMALLOC_NEWIMPLPARSDEFS
#undef NEDMALLOC_NEWIMPLPARS

#define NEDMALLOC_NEWIMPLTYPES typename P1, typename P2, typename P3, typename P4, typename P5,typename P6,typename P7
#define NEDMALLOC_NEWIMPLPARSDEFS   P1 &p1,   P2 &p2,   P3 &p3,   P4 &p4,   P5 &p5 ,P6 &p6 ,P7 &p7 
#define NEDMALLOC_NEWIMPLPARS p1, p2, p3, p4, p5,p6 ,p7  
NEDMALLOC_NEWIMPL
#undef NEDMALLOC_NEWIMPLTYPES
#undef NEDMALLOC_NEWIMPLPARSDEFS
#undef NEDMALLOC_NEWIMPLPARS
