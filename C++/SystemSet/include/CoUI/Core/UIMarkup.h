...
public:
    ...
    bool LoadFromFile(LPCTSTR pstrFullFilePath, int encoding = XMLFILE_ENCODING_UTF8);
    bool LoadFromZip(LPCTSTR pstrFilename, HANDLE hFileHandle, int encoding = XMLFILE_ENCODING_UTF8);
