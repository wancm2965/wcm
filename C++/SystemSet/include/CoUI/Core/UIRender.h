...
/////////////////////////////////////////////////////////////////////////////////////
//
#define COUI_DT_JUSTIFY (DT_CENTER|DT_RIGHT)//文本两端对齐
...
public:
    ...
    static HRGN CreateHRgnFromBmp(HBITMAP hBitMap);//获取32位位图非透明区域
	static bool RenderRichWnd(HWND hWnd,HDC hDCdes,POINT *ptDes,SIZE *size,HDC hDCsrc,POINT *ptSrc,COLORREF color,BLENDFUNCTION *blen,DWORD flag);//托管分层窗口绘制
