...
public:
	...
	virtual bool OpenSaveFile(BOOL bOpenSave, char* sFilePath, LPCTSTR lpszDefExt = NULL,LPCTSTR lpszFilter = NULL,HWND hParent=NULL ,LPCTSTR strFilePath =_T("")){return false;}
	virtual int MessageBox(HWND hOwner,CString strTitle,CString strContent,UINT nStye, bool bAutoDestroy = false){return 0;};
