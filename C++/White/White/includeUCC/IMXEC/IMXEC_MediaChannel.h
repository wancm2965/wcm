...
public:
	...
	*****************************************************************************/
	...
	//打开视频设备
	virtual int OpenVideoDev(int nDevID,int nWidth,int nHeight,int nFrameRate,int nBitrate,int nBitrateControlType,VIDEC_CODEC_TYPE CodecType,int nSub=0,int nQSub=0,const char*cszDVCIP=NULL,unsigned short nDVCPort=4222,const char*cszDVCPassword=NULL)=0;
