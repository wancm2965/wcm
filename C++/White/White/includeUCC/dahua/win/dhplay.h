 ...
 * Date: 2006.12
	purpose:	Provide the function interface definition and explanation for user to develop for the second times.
*********************************************************************/
#ifndef _DHPLAY_H
#define _DHPLAY_H
...
#define  FUNC_MAX_PORT 100              //Max play amount 
//Wave coef range;
...
#define DH_PLAY_ALLOC_MEMORY_ERROR		6		       //Failed to allocate memory£»
...
#define DH_PLAY_SET_VOLUME_ERROR		13	           //Failed to set audio £»
#define DH_PLAY_SUPPORT_FILE_ONLY		14		       //use this interface when play file£»
#define DH_PLAY_SUPPORT_STREAM_ONLY		15		       //Use this interface when play stream£»
#define DH_PLAY_SYS_NOT_SUPPORT			16		       //System does not support. Decoder can only work in Pentium 3 or higher£»
#define DH_PLAY_FILEHEADER_UNKNOWN		17		       //No file head£»
#define DH_PLAY_VERSION_INCORRECT		18	           //The decoder and decoder version does not match£»
...
#define DH_PLAY_UPDATE_ERROR            23			   //Failed to diaplay overlay£»
...
//The function system supported. The bitwise represents the system function.
#define SUPPORT_DDRAW		1  //Suuport DIRECTDRAW£»Otherwise the player can not work.
#define SUPPORT_BLT         2  //Display card supports BLT operation£»otherwise the player can not work.
#define SUPPORT_BLTFOURCC   4  //Display card BLT supports color switch.
#define SUPPORT_BLTSHRINKX  8  //Display card BLT supports X axix zoom out£»
#define SUPPORT_BLTSHRINKY  16 //Display card BLT supports Y axis zoom out£»
#define SUPPORT_BLTSTRETCHX 32 //BLT supports X axix zoom in£»
#define SUPPORT_BLTSTRETCHY 64 //BLT supports Y axix zoom in£»
#define SUPPORT_SSE         128 //CPU command SSE. Intel Pentium 3 or higher supports SSE command£»
#define SUPPORT_MMX			256 //CPU supports MMX instruciton set.
...
//There are two external interfaces for user 2nd development to callback.
//These following two interfaces do not need to be called.
