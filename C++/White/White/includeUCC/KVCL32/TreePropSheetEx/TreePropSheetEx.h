...
/*! @brief Extended version of CTreePropSheet
  ...
  @date 07/2004 */
class AFX_EXT_CLASS CTreePropSheetEx
...
public:
	CTreePropSheetEx(BOOL bAutoClose = FALSE);
	CTreePropSheetEx(UINT nIDCaption, CWnd* pParentWnd = NULL, UINT iSelectPage = 0, BOOL bAutoClose = FALSE);
	CTreePropSheetEx(LPCTSTR pszCaption, CWnd* pParentWnd = NULL, UINT iSelectPage = 0, BOOL bAutoClose = FALSE, BOOL bInMeetting = FALSE);
