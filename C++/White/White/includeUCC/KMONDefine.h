...
#define _OPERATION_
//设备修改
enum DEV_GROUP_UPDATE_OPERATION
{
    DEV_GROUP_INFO = 0,
    DEV_GROUP_ADD,            //添加设备    
    DEV_GROUP_MODIFY,         //修改设备信息
    DEV_GROUP_DELETE,         //删除设备
    
};

//通道改变
enum CHANNEL_UPDATE_OPERATION
{
    CHANNEL_NODE = 0,
    CHANNEL_ADD,        //添加设备
    CHANNEL_MODIFY,         //修改设备信息
    CHANNEL_DELETE,         //删除设备    
};
#endif

//成员改变
enum MMS_MEMBER_UPDATE_TYPE
{
    MMS_MEMBER_ADD = 1,        //添加成员
    MMS_MEMBER_MODIFY,         //修改成员信息
    MMS_MEMBER_DELETE,         //删除成员    
};
...
typedef enum _MON_FACTORY
{
	...
	BSC_DVR, /*蓝卫通*/
	XINQI_DVR, /*芯启*/
	SKY_DVR, /*蓝色星际7000、8000系列设备*/
	SKY_DVR_6K = 15,/*蓝色星际5000、6000系列设备*/
	MAX_DVR,
...
//=======================================================================================
//UDP港航局
typedef struct _UDP_RCV_GHJ_INFO
{
	_UDP_RCV_GHJ_INFO()
	{
		nStatus = 1;
	...
	std::string strType;    //信息类型，GHJ表示港航局
	std::string strChannelID;
	std::string strSender;
	std::string strReceiver;
	std::string strSendTime;
	std::string strExtend;	//扩展信息
	int	nStatus;			//0关，1开，2关所有
	int nScreenID;			//屏号
	int nWindowID;			//窗口号
}UDP_RCV_GHJ_INFO,*PUDP_RCV_GHJ_INFO;
//========================================================================================
