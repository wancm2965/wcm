...
{	
	...
	//26 return CString(CPaintManagerUI::GetInstancePath()) + _T("skin\\Plugin_U7T_Meeting\\");
}
...
//#endif
	...
	CControlUI* pRoot = builder.Create(strSkin.GetBuffer(), (UINT)0, this, &paint_manager_);
	if (pRoot)
	{
