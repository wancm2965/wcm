...
HDXF dxfCreateFile( LPCTSTR FileName )
{
	...
	strcpy_s( pDxf->Write.CurrentLayer, "0" );
	strcpy_s( pDxf->Write.CurrentLine, "" ); // BYLAYER
	strcpy_s( pDxf->Write.CurrentTextStyle, "" );// STANDARD
	strcpy_s( pDxf->Write.CurrentDimStyle, "ClosedFilled");
