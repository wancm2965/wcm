...
BOOL dxfSetCurrentLayer( HDXF hDxf, char* Name, char* LineType )
{
	...
	if(Name!=NULL)
		strcpy_s( pDxf->Write.CurrentLayer, Name );
	else
	{
	...
	if(LineType!=NULL)
		strcpy_s( pDxf->Write.CurrentLine, LineType );
	else
		strcpy_s( pDxf->Write.CurrentLine, "" );
...
BOOL dxfSetCurrentLinetype( HDXF hDxf, char* Name )
{
	...
	strcpy_s( pDxf->Write.CurrentLine, Name );
...
BOOL dxfSetCurrentTextStyle( HDXF hDxf, char* Name )
{
	...
	strcpy_s( pDxf->Write.CurrentTextStyle, Name );
...
BOOL dxfSetCurrentDimStyle( HDXF hDxf, LPCTSTR Name )
{
	...
	strcpy_s( pDxf->Write.CurrentDimStyle, Name );
