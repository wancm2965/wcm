...
//图元 线宽 
static int cadWidth[2][25] = 
{
	{-2, 0, 5, 9, 13, 15, 18, 20, 25, 30, 35, 40, 50, 53, 60, 70, 80, 90, 100, 106, 120, 140, 158, 200, 211}, //cad线宽 单位(mm/100)
	{1, 1, 1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 5, 5, 7, 7, 9, 9, 11, 11, 13, 13, 14, 15, 15} //gdi 对应线宽
};
