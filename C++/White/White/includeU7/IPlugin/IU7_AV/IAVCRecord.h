...
#define	__AVC_RECORD_H__
	...
	#include "IPlugin/IU7_AV/AVCFileDefine.h"
#endif
...
AFX_EXT_CLASS bool CreateAVCRecordFactory(IAVCRecordFactory** ppARF, IAVCRecordFactoryEvent* pEvent);
AFX_EXT_CLASS bool CreateAVCReadFactory(IAVCReadFactory** ppARF);
AFX_EXT_CLASS bool CreateAVCEditFactory(IAVCEditFactory** ppAEF);
