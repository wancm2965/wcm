...
public:
	...
	*****************************************************************************/
	...
	/******************************************************************************
	* OnChangeRecName
	*描述：单录的时候，如果发现不能录制为mkv格式，就更改文件名字
	*输入：strOldFilePath 旧路径名，strNewFileName 新文件名，strNewFilePath新路径名 strNickName 昵称 uCutIndex 切割索引
	*输出： 
	*返回值：无
	*****************************************************************************/
	virtual void OnChangeRecFilePath(const std::string& strOldFilePath, const std::string& strNewFileName, const std::string& strNickName, unsigned int uCutIndex, const std::string& strNewFilePath) = 0;
...
public:
	...
	*****************************************************************************/
	...
	virtual void SavePicture(const std::string& strRoomID, const std::string& strDevID, const std::string& strChnID, bool bConfRecord, const std::string& strImgData)=0;
	virtual void ChangeStreamType(const std::string& strRoomID,const std::string& strDevid,const std::string& strChnID,unsigned short uStreamType,const std::string& strUserid)=0;
