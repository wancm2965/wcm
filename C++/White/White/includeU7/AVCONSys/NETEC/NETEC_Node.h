...
public:
	...
	*返回值：连接的MCU的类型
	*****************************************************************************/
	static uint32_t GetMCUType(void);
	...
	*返回值：无
	*****************************************************************************/
	virtual void OnNETEC_NodeReceivedFromAgent(const char*cszDomain,uint32_t nAgentID,const char* pData,int32_t nLen){};
	...
	*返回值：无
	*****************************************************************************/
	virtual void OnNETEC_NodeReceivedFromRouter(const char*cszDomain,const char* pData,int32_t nLen){};
	...
	*返回值：无
	*****************************************************************************/
	virtual void OnNETEC_NodeReceivedFromNode(const char*cszNodeID,uint32_t nFromAgentID,uint32_t nToAgentID,const char* pData,int32_t nLen){};
	...
	*返回值：无
	*****************************************************************************/
	virtual void OnNETEC_NodeNodeDisconnected(const char*cszNodeID,uint32_t nFromAgentID,uint32_t nToAgentID,const char* pData,int32_t nLen){};
	...
	*返回值：无
	*****************************************************************************/
	virtual void OnNETEC_NodeAgentDisconnected(const char*cszDomain,uint32_t nAgentID,const char* pData,int32_t nLen){};
	...
	*返回值：无
	*****************************************************************************/
	virtual void OnNETEC_NodeRouterDisconnected(const char*cszDomain,const char* pData,int32_t nLen){};
	...
	*****************************************************************************/
	virtual int32_t OnNETEC_NodeGetUserInfo(const char*cszUserID,char*szNodeID){return -1;};
	...
	*****************************************************************************/
	static int32_t GetMCUIsDetached(void);
};
