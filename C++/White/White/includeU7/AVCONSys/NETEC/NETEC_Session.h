...
public:
	//连接服务器
	virtual int32_t Connect(const char*cszIP,unsigned short usPort,const char*cszInterface)=0;
	//断开连接
	virtual void Disconnect(void)=0;
	//收到连接状态
	virtual void OnNETEC_SessionConnectStatus(NETEC_Session::CONNECT_STATUS cs,int32_t nErrorCode=0)=0;
};
