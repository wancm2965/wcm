...
AVCONEC_API bool IsAudioHardware(int nChannelIndex);
AVCONEC_API void SetAudioRecordDevice(unsigned int nDevice);
AVCONEC_API unsigned int GetAudioRecordDevice(void);
AVCONEC_API void SetAudioPlayDevice(unsigned int nDevice);

//判断是高清设备
AVCONEC_API bool IsHDDevice(int nDevID);


//{{xmc add 20070830
AVCONEC_API int SD_GetFormatCount(void);
AVCONEC_API bool SD_GetFormatName(int nIndex,char*szName);
AVCONEC_API bool SD_GetFormatSize(int nIndex,int&nWidth,int&nHeight);

AVCONEC_API int HD_GetFormatCount(void);
AVCONEC_API bool HD_GetFormatName(int nIndex,char*szName);
AVCONEC_API bool HD_GetFormatSize(int nIndex,int&nWidth,int&nHeight);
//}}
...
public:
	...
	*****************************************************************************/
	...
	virtual void LevelFixer(bool bLevelFixer)=0;
	virtual bool IsLevelFixer(void)=0;
};


AVCONEC_API IHPAVCapture*CreateIHPAVCapture(IHPAVCaptureNotify&rIHPAVCaptureNotify
#ifdef _WIN32
											  ,HWND hWndVideo
#endif
											  );
...
AVCONEC_API IHPAVPlayer*CreateIHPAVPlayer(HWND hWndVideo);
